...
**Revenue:** $29–$299 per workflow (one-time)
**Effort:** Low
...
- Price based on value delivered (e.g., "saves 5 hours/week = worth $99")
...
**Revenue:** $299–$3,000/client/month
**Effort:** Medium
...
|------|-------------|-----------------|
| Starter | $299 | 3 pre-built workflows, Slack support |
| Growth | $599 | 8 workflows, custom builds, priority support |
| Scale | $1,200 | Unlimited workflows, dedicated setup, SLA |

**How to get first clients:**
1. Offer free 2-week trial with one workflow
2. Show the ROI: "I'll save you 10 hours/week — at $50/hour that's $2,000/month value for $299"
...
**Revenue:** $1,000–$5,000/month per client
...
**Week 1-2:**
- [ ] Set up n8n on Hetzner VPS (€5/month)
- [ ] Create GitHub repo with 5 free workflows (this repo)
- [ ] Build simple landing page: flowmindlabs.com/workflows
- [ ] Set up Gumroad or Lemon Squeezy for payments

**Week 3-4:**
- [ ] Launch 5 premium workflows at $49 each on Gumroad
- [ ] Post 1 LinkedIn post/day showing workflow demos
- [ ] Goal: 10 workflow sales = $490 revenue

### Month 2 — Retainers ($500 → $2,000 MRR)
- [ ] Reach out to 20 startup founders on LinkedIn
- [ ] Offer: "Free 2-week automation audit"
- [ ] Convert 3 to $599/month retainers = $1,797 MRR
- [ ] Add workflow request form to website

### Month 3 — Scale ($2,000 → $4,300 MRR)
- [ ] First white-label client at $1,200/month
- [ ] Raise retainer pricing for new clients to $799/month
- [ ] Hire 1 part-time developer for workflow builds
- [ ] Total: 3 retainers ($1,797) + 1 white-label ($1,200) + workflow sales ($1,000+) ≈ **$4,300 MRR**
...
**Monthly infrastructure cost: ~€15-30/month**
- Hetzner CX31 (4 vCPU, 8GB): €8/month
...
| Workflow saves per week | Fair price |
|------------------------|------------|
| 1-2 hours | $29–$49 |
| 3-5 hours | $79–$149 |
| 5-10 hours | $149–$299 |
...
- "AI Ops Pack" (4 workflows) at $149 instead of 4 × $49 = $196
- "Complete Automation Kit" (all 17 workflows) at $499

---

## The n8n Workflow as SaaS — n8n's Own Approach

n8n itself now offers n8n Cloud at $20-120/month — proof the model works. You're doing the same but adding:
- Done-for-you setup
...
1. Register as sole proprietor / one-person company (varies by country)
2. Open a business bank account
3. Use Stripe Atlas or Razorpay for payments
4. Add Terms of Service + Privacy Policy (use free generator at termly.io)
5. Invoice clients via Wave (free invoicing tool)

**India-specific:**
- Register as Individual/Freelancer initially
- Once >₹20 lakh revenue, register as LLP or Pvt Ltd
- Get GST registration when applicable
...
**Cold email subject:** `"I built an automation that would save [Company] ~$2k/month"`
...
- **Payment processing:** gumroad.com or lemonsqueezy.com
